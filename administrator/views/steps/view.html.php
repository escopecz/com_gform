...
class GformViewSteps extends JViewLegacy
{
	...
	protected function addToolbar()
	{
		...
		$canDo	= GformHelper::getActions($state->get('filter.category_id'));

		JToolBarHelper::title(JText::_('COM_GFORM_TITLE_STEPS'), 'steps.png');
		...
		if ($canDo->get('core.admin')) {
			JToolBarHelper::preferences('com_gform');
		}
